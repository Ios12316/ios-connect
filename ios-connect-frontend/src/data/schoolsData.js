// Lists of faculties, schools, colleges, and departments per university
export const schoolFacultyDepartments = {
  "AAUA": {
  ...
  "LASU": {
    ...
    "School of Creativity, Culture and Tourism Studies": [
